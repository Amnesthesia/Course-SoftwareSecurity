...
\begin{myfont}
\textsc{\Large Assignment \#4}\\[0.5cm] % Major heading such as course name
\textsc{\large Code Review}\\[0.5cm] % Minor heading such as course title
\end{myfont}
...
%	EXECUTIVE SUMMARY
%----------------------------------------------------------------------------------------
\input{"review.tex"} % Includes the file that contains the introduction
