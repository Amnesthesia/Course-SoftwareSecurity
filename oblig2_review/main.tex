...
\begin{myfont}
{ \huge \bfseries Software Security}\\[0cm] % Title of your document
\end{myfont}
...
\begin{myfont}
\textsc{\Large Assignment \#2 - Review}\\[0.5cm] % Major heading such as course name
\textsc{\large Electronic Voting System - Race Conditions}\\[0.5cm] % Minor heading such as course title
\end{myfont}
...
\emph{Authors:}\\
\begin{myfont}
Jannis \textsc{Schaefer} - 120914\\ % Your name
\end{myfont}
\end{flushleft}
...
%	EXECUTIVE SUMMARY
%----------------------------------------------------------------------------------------
\includepdf[pages={2-}]{02_120914_Schaefer.pdf}
\input{"tpe.tex"} % Includes the file that contains the introduction
