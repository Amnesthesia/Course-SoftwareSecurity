...
\begin{myfont}
\textsc{{\huge Gjøvik University College}}\\[0.5cm] % Name of your university/college
\end{myfont}

\includegraphics[width=150px, height=150px]{logo}\\[0.8cm] % Include a department/university logo - this will require the graphicx package 403x403px


\begin{myfont}
\textsc{\Large Linux Operating System}\\[0.5cm] % Major heading such as course name
\textsc{\large Software Security}\\[0.5cm] % Minor heading such as course title
\end{myfont}

\HRule \\[0.4cm]
\begin{myfont}
{ \huge \bfseries \bf Assignment \#1 - Reviewed }\\[0cm] % Title of your document
\end{myfont}
\HRule \\[0.4cm]
...
%----------------------------------------------------------------------------------------
\section{Original}
\includepdf[pages={3-}]{subject.pdf}
\section{Review}
\input{review.tex}
